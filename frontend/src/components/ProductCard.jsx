  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", height: 200, overflow: "hidden", background: "#f3f4f6" }}>
        ...
        {/* Wishlist button — always visible, colored when active */}
        {!isGuest && (
          <button
            onClick={handleWishlist}
            style={{
              position: "absolute", top: 10, right: 10,
              background: inWishlist ? "#ef4444" : "rgba(255,255,255,0.9)",
          ...
          >
            <FaHeart style={{ fontSize: "0.85rem", color: inWishlist ? "#fff" : "#6b7280" }} />
          </button>
        )}
      ...
      <div style={{ padding: "0.85rem", display: "flex", flexDirection: "column", gap: "0.3rem", flex: 1 }}>
        <span style={{ fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.08em", color: "#9ca3af", textTransform: "uppercase" }}>
          {product.category}
        </span>
        <div style={{
        ...
        {/* Price */}
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginTop: "auto", paddingTop: "0.3rem" }}>
        ...
        <button
          ...
          style={{
            marginTop: "0.5rem",
            background: inStock || isGuest ? "#111" : "#e5e7eb",
          ...
          onMouseEnter={e => { if (inStock || isGuest) e.currentTarget.style.background = "#374151"; }}
          onMouseLeave={e => { if (inStock || isGuest) e.currentTarget.style.background = "#111"; }}
        >
