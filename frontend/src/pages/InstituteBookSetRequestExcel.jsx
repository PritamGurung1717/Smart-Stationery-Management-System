      ...
      <div className="container py-4" style={{ maxWidth: 900 }}>
        ...
        <div className="mb-4">
          ...
          <h2 className="fw-bold mb-2" style={{ fontSize: "clamp(1.4rem,3vw,1.9rem)", letterSpacing: "-0.02em" }}>
            Upload Book Sets via Excel
          </h2>
          <p className="text-muted">Upload multiple book set requests at once using an Excel file</p>
        </div>
        ...
        <div className="bg-white border p-4 mb-4">
          ...
          <ol className="mb-3" style={{ fontSize: "0.9rem", lineHeight: 1.8 }}>
            ...
            <li>Note: Price will be set by admin after approval</li>
        ...
        <div className="bg-light border p-4 mt-4">
          <h6 className="fw-bold mb-3">Excel Format Example</h6>
          ...
          <p className="text-muted small mt-2 mb-0">
            <strong>Note:</strong> Books with the same School Name and Grade will be grouped together into one request. Price will be set by admin.
          </p>
        </div>
      </div>
    </SharedLayout>
